...
export const deleteFilterType = "search:deleteFilter";
export interface DeleteFilterAction extends Action<string> {
  field: string;
}
export const deleteFilterAction = (field: string) => ({
  field,
  type: deleteFilterType
});
